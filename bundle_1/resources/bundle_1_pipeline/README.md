...
This folder defines all source code for the bundle_1_pipeline pipeline:
...
* Take a look at the sample under "sample_trips_bundle_1.py" to get familiar with the syntax.

...
This folder defines all source code for the bunle_poc pipeline:
...
* Take a look at the sample under "sample_trips_bunle_poc.py" to get familiar with the syntax.
